...
const Ray = ({
  ...
  return (
    <motion.div
      className="pointer-events-none absolute -top-[12%] origin-top -translate-x-1/2 rounded-full bg-gradient-to-b from-[color-mix(in_srgb,var(--light-rays-color)_70%,transparent)] to-transparent opacity-0 mix-blend-screen"
      style={
        {
          left: `${left}%`,
          width: `${width}px`,
